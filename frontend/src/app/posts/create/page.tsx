...
const createPostSchema = z.object({
  title: z.string().min(3, 'Заголовок повинен містити мінімум 3 символи').max(200, 'Заголовок занадто довгий'),
  description: z.string().max(500, 'Опис занадто довгий').optional().or(z.literal('')),
  content: z.string().min(10, 'Контент повинен містити мінімум 10 символів').max(10000, 'Контент занадто довгий'),
});
...
export default function CreatePostPage() {
  ...
  const onSubmit = async (data: CreatePostFormValues) => {
    try {
      ...
      const errorMessage = err.response?.data?.message || 'Помилка створення поста';
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-3 pt-4">
                  ...
                  >
                    ...
                    {createPostMutation.isPending ? 'Створення...' : 'Опублікувати пост'}
                  </Button>
                  <Button
                    type="button"
                    variant="outline"
        ...
        <Card className="mt-6 bg-blue-50 border-blue-200">
          <CardContent className="pt-6">
            <h3 className="font-medium text-blue-900 mb-2">Поради для написання хорошого поста:</h3>
